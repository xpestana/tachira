            	...
            	<div class="row justify-content-center">
                	<div class="col-lg-12 text-center">
                    	<div class="page-next-level title-heading">
                        	<h1 class="text-white title-dark"> Contactanos </h1>
                        	<p class="text-light para-desc mb-0 mx-auto">Start working with Landrick that can provide everything.</p>
                        	<div class="page-next">
                            <nav aria-label="breadcrumb" class="d-inline-block">
                                <ul class="breadcrumb bg-white rounded shadow mb-0">
                                    <li class="breadcrumb-item">
                                        <Link :href="route('home')">Landrick</Link>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0)" class="active">Contactanos</a></li>
                                </ul>
                            </nav>
                        	</div>
                    	</div>
